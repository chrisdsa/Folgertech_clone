...
// 5 is 100K thermistor - ATC Semitec 104GT-2 (Used in ParCan & J-Head) (4.7k pullup)F
...
#define HOMING_FEEDRATE {500,500, 50, 0}  // set the homing speeds (mm/min)

// default settings

#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,400,111}  // default steps per unit for Ultimaker
